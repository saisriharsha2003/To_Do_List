...
function addTask() {
    ...
    taskDeadline.innerText = `Deadline: ${deadlineText}`;
...
function showAllTasks() {
  ...
  function sortTasksByDeadline() {
    ...
    tasks.sort((a, b) => {
      const aDeadline = new Date(a.querySelector('.task-deadline').innerText.substr(10));
      const bDeadline = new Date(b.querySelector('.task-deadline').innerText.substr(10));
...
// Add event listener to show completed tasks
document.getElementById('showCompletedTasks').addEventListener('click', showCompletedTasks);

// Add event listener to show pending tasks
document.getElementById('showPendingTasks').addEventListener('click', showPendingTasks);
